...
export class EODCashiers extends Component {
  state = {
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    // onSaveDenominationReport: (token, startDate, endDate, branchId, denominationValue) => (actions.saveDenominationReport(token, startDate, endDate, branchId, denominationValue))
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(withStyles(useStyles)(EODCashiers));
