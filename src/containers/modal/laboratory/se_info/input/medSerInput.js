            ...
            <CRow className="ml-1 mr-1 p-0">
                <CCol md="6" className="p-1">
                    <FormControl fullWidth className={clsx(classes.margin, "m-0 p-0")} variant="outlined" margin='dense'>
                        ...
                        <Select
                            native
                            defaultValue={JSON.stringify(props.seroData.medSer.referenceLabId) || ""}
                            onChange={
                                props.index !== undefined && props.index !== null
                                    ? props.handleSelectChange('medSer', 'referenceLabId', props.index)
                                    : props.handleSelectChange('medSer', 'referenceLabId')
                            }
                        >
