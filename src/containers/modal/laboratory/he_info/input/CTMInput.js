            ...
            <CRow className="ml-1 mr-1 p-0">
                <CCol md="4" className="p-1">
                    <FormControl fullWidth className={clsx(classes.margin, "m-0 p-0")} variant="outlined">
                        ...
                        <CInput
                            type="number"
                            value={props.hemaData.ctm.timeMin}
                            onChange={
                                props.index !== undefined && props.index !== null
                                    ? props.handleChange('ctm', 'timeMin', props.index)
                                    : props.handleChange('ctm', 'timeMin')
                            }
                        />
                    </FormControl>
                </CCol>
                <CCol md="2" className="p-1 mt-4">
                    <strong className={clsx(classes.labelText)}>4-10 Minutes</strong>
                </CCol>
                <CCol md="4" className="p-1">
                    <FormControl fullWidth className={clsx(classes.margin, "m-0 p-0")} variant="outlined">
                        ...
                        <CInput
                            type="number"
                            value={props.hemaData.ctm.timeSec}
                            onChange={
                                props.index !== undefined && props.index !== null
                                    ? props.handleChange('ctm', 'timeSec', props.index)
                                    : props.handleChange('ctm', 'timeSec')
                            }
                        />
                    </FormControl>
                </CCol>
