...
const RBSInput = (props) => {
    ...
    let rbsconv = '0.00'
    if (props.chemData.rbs.conventional !== '') rbsconv = props.chemData.rbs.conventional
            ...
            <CRow className="ml-1 mr-1 p-0">
                <CCol md="3" className="p-1">
                    <FormControl fullWidth className={clsx(classes.margin, "m-0 p-0")} variant="outlined">
                        ...
                        <CInput
                            type="number"
                            value={props.chemData.rbs.result}
                            onChange={
                                props.index !== undefined && props.index !== null
                                    ? props.handleChange('rbs', 'result', props.index)
                                    : props.handleChange('rbs', 'result')
                            }
                        />
                    </FormControl>
                </CCol>
                ...
                <CCol md="3" className="p-1">
                    ...
                    <CLabel className={"mb-0 ml-2 font-weight-bold"}>{rbsconv}</CLabel>
