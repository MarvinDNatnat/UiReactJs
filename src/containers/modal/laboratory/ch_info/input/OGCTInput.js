...
const OGCTInput = (props) => {
    ...
    let ogctconv = '0.00'
    if (props.chemData.ogct.conventional !== '') ogctconv = props.chemData.ogct.conventional
            ...
            <CRow className="ml-1 mr-1 p-0">
                <CCol md="3" className="p-1">
                    <FormControl fullWidth className={clsx(classes.margin, "m-0 p-0")} variant="outlined">
                        ...
                        <CInput
                            type="number"
                            value={props.chemData.ogct.result}
                            onChange={
                                props.index !== undefined && props.index !== null
                                    ? props.handleChange('ogct', 'result', props.index)
                                    : props.handleChange('ogct', 'result')
                            }
                        />
                    </FormControl>
                </CCol>
                ...
                <CCol md="3" className="p-1">
                    ...
                    <CLabel className={"mb-0 ml-2 font-weight-bold"}>{ogctconv}</CLabel>
                    <CLabel className={"mb-0 ml-2"}>mg/dl</CLabel>
                </CCol>
                <CCol md="2" className="p-1 mt-2">
                ...
                <CCol md="4" className="p-1">
                    <FormControl fullWidth className={clsx(classes.margin, "m-0 p-0")} variant="outlined" margin='dense'>
                        ...
                        <Select
                            native
                            defaultValue={JSON.stringify(props.chemData.ogct.referenceLabId) || ""}
                            onChange={
                                props.index !== undefined && props.index !== null
                                    ? props.handleSelectChange('ogct', 'referenceLabId', props.index)
                                    : props.handleSelectChange('ogct', 'referenceLabId')
                            }
                        >
