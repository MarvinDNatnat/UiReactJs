            ...
            <CRow className="ml-1 mr-1 p-0">
                <CCol md="3" className="p-1">
                    <FormControl fullWidth className={clsx(classes.margin, "m-0 p-0")} variant="outlined">
                        ...
                        <CInput
                            type="number"
                            value={props.chemData.tibc.result}
                            onChange={
                                props.index !== undefined && props.index !== null
                                    ? props.handleChange('tibc', 'result', props.index)
                                    : props.handleChange('tibc', 'result')
                            }
                        />
                    </FormControl>
                </CCol>
                ...
                <CCol md="2" className="p-1 mt-4">
                    <strong className={clsx(classes.labelText)}>{'45-72'}</strong>
                </CCol>
                <CCol md="5" className="p-1">
                    <FormControl fullWidth className={clsx(classes.margin, "m-0 p-0")} variant="outlined" margin='dense'>
                        ...
                        <Select
                            native
                            defaultValue={JSON.stringify(props.chemData.tibc.referenceLabId) || ""}
                            onChange={
                                props.index !== undefined && props.index !== null
                                    ? props.handleSelectChange('tibc', 'referenceLabId', props.index)
                                    : props.handleSelectChange('tibc', 'referenceLabId')
                            }
                        >
