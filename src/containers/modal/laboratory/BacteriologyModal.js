...
const BacteriologyModal = (props) => {
    ...
    useEffect(() => {
        const serviceRequest = props.bacteriologyData.serviceRequest;
    ...
    const validateInputs = () => {
        ...
        if (props.bacteriologyData.bacteriology.pathologist === null) {
    ...
    const handleSelectChange = (opt, prop) => (event) => {
        const updateBacteriologyData = updateObject(props.bacteriologyData, {
            [opt]: updateObject(props.bacteriologyData[opt], {
                [prop]: event,
            })
        });

        props.setBacteriologyData(updateBacteriologyData);
    }

    let defpatho = null
    const indDoct = props.bacteriologyData.bacteriology
    ...
    return (
        ...
        >
            <CModalHeader className={classes.cardBlueWhite} closeButton >
                <CModalTitle className="font-weight-bold">Bacteriology</CModalTitle>
            </CModalHeader>

            <CModalBody>

                <PatientInformation
                    propData={props.bacteriologyData}
                />
            ...
            <CModalFooter>
                ...
                {props.editViewFlag === true
                    ...
                    >
                        ...
                        Print Bacteriology Report</CButton>
                    : <CButton
                        className="border border-dark"
                        color="primary"
                ...
                {props.editViewFlag === true
                    ? <CButton
                        className="border border-dark"
                        color="warning"
                    onClick={() => props.onQualityControl(props.bacteriologyData.txnId, props.bacteriologyData.id)}
                    >
...
export default BacteriologyModal;