...
import SOPListTable from 'src/containers/tables/sop/SOPListTable';
                ...
                <CModalBody className="m-0 p-0">
                    <CCard className="m-0 p-0">
                        <CCardHeader>
                            <CRow className="m-0 p-0">
                                ...
                                <CCol md="6" className="m-0 p-0">
                                    Name : <strong>{this.props.referenceLab !== null ? this.props.referenceLab.label : ""}</strong>
                                </CCol>
                        ...
                        <CCardBody className={clsx(classes.cardBody, "m-0 p-0")}>
...

                                {
                                    this.props.paymentType !== null && this.props.paymentType.value !== 'CA'
                                        ? <CCol md="3" className="p-0 pr-4">
                                            <FormControl fullWidth className={clsx(classes.margin)} variant="outlined">
                                                <CLabel className={clsx(classes.labelText, "mb-0 ml-2")}>Acct/CHQ No./Ext. Ref. No. </CLabel>
                                                <OutlinedInput
                            ...
                            {
                                this.props.sopOption === 'payments' && this.props.verified === null
                            ...
                            <div className="table-responsive m-0 p-0">
                                <SOPListTable
                                    sopList={this.props.sopPaymentList}
                                />
                            </div>
                        </CCardBody>
                        <CCardFooter>
                            <CRow className="m-0 p-0">
                                <CCol md="6" className="col-12 m-0 p-0 text-left">
                                    {/* Prepared By : <strong>{this.props.pn === 'payments' ? labPersonName(this.props.prepared, false) : ''}</strong> */}
                                </CCol>
                                <CCol md="3" className="col-12 m-0 p-0 text-right">
                                    <strong>TOTAL TXN  :  {this.props.sopPaymentList.length}</strong>
                                </CCol>
                                <CCol md="3" className="col-12 m-0 p-0 text-right">
                    ...
                    }
                    {
                        this.props.sopOption === 'payments' && this.props.verified === null
                            ? <CButton
                                className="border border-dark"
                                color="info"
                                onClick={this.props.verifySOPPayment}
                            >
                                Verify
                            </CButton>
                            : null
