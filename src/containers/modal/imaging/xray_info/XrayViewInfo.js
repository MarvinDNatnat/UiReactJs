                ...
                <CCardBody>
                    <CRow className="ml-1 mr-1 p-0">
                        ...
                        <CCol md="10" className="p-1">
                            <CLabel className="mb-0 ml-2 font-weight-bold">{props.xrayData.xray.findings}</CLabel>
                        </CCol>
                    </CRow>
                    ...
                    <CRow className="ml-1 mr-1 p-0">
                        ...
                        <CCol md="10" className="p-1">
                            <CLabel className="mb-0 ml-2 font-weight-bold">{props.xrayData.xray.impressions}</CLabel>
                        </CCol>
                    </CRow>
                </CCardBody>
            </CCard>
            ...
            <CCard className="mb-1">
                ...
                <CCardBody>
                    ...
                    <CRow className="ml-1 mr-1 p-0">
                        ...
                        <CCol md="8" className="p-1">
                            <CLabel className="mb-0 ml-2 font-weight-bold">
                                {props.xrayData.xray.radiologist.label}
                            </CLabel>
                        </CCol>
                    </CRow>
